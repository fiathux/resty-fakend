...
cd /home/depsource
curl https://openresty.org/download/openresty-1.15.8.2.tar.gz>openresty-1.15.8.2.tar.gz
...
cd /home/depsource
curl -L http://luarocks.github.io/luarocks/releases/luarocks-3.0.3.tar.gz>luarocks-3.0.3.tar.gz
...
cd /home/depsource
curl -L https://github.com/mongodb/mongo-c-driver/releases/download/1.13.0/mongo-c-driver-1.13.0.tar.gz>mongo-c-driver-1.13.0.tar.gz
